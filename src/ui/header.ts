...
// <sj-header>: otsikko + i-info-, ennätys- ja uusi peli -napit.
// Emittoi "open-rules" / "open-highscores" / "new-game". Sisältö hoidetaan app-tasolla.
// Asetukset-ratas palaa kun asetuksia oikeasti on (ks. TODO.md).
