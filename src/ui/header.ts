...
// <sj-header>: otsikko + i-info-, ennätys-, asetus- ja uusi peli -napit.
// Emittoi "open-rules" / "open-highscores" / "open-settings" / "new-game".
// Sisältö hoidetaan app-tasolla.
export class AppHeader extends HTMLElement {
  connectedCallback(): void {
    this.innerHTML = `
      <header class="app-header">
        ...
        <div class="header-btns">
          ...
          <button class="icon-btn" data-act="about" title="${T.about}" aria-label="${T.about}">ℹ</button>
    ...
    this.querySelector('[data-act="about"]')!.addEventListener("click", () => emit("open-about"));
